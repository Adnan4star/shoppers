        ...
        <div class="row">
          <div class="col-sm-6 col-md-6 col-lg-4 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
            <a class="block-2-item" href="#">
              <figure class="image">
                <img src="{{ asset('front-assets/images/women.jpg') }}" alt="" class="img-fluid">
              </figure>
              <div class="text">
          ...
          <div class="col-md-12">
            <div class="nonloop-block-3 owl-carousel">
              ...
              <div class="item">
                <div class="block-4 text-center">
                  <figure class="block-4-image">
                    <img src="{{ asset('front-assets/images/cloth_2.jpg') }}" alt="Image placeholder" class="img-fluid">
                  </figure>
                  <div class="block-4-text p-4">
              ...
              <div class="item">
                <div class="block-4 text-center">
                  <figure class="block-4-image">
                    <img src="{{ asset('front-assets/images/cloth_3.jpg') }}" alt="Image placeholder" class="img-fluid">
                  </figure>
                  <div class="block-4-text p-4">
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-7 mb-5">
            <a href="#"><img src="{{ asset('front-assets/images/blog_1.jpg') }}" alt="Image placeholder" class="img-fluid rounded"></a>
          </div>
