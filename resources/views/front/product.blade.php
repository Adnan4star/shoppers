                  ...
                  <div class="col">
                    <form action="" name="productRatingForm" id="productRatingForm" method="POST">
                      ...
                      <div class="form-group mb-3 col-md-6">
                        ...
                        <br>
                        <div class="rating pt-1 pl-3" style="width: 10rem ">
                            <input id="rating-5" type="radio" name="rating" value="5"/><label for="rating-5"><i class="fa fa-star" style="font-size: 20px"></i></label>
                            <input id="rating-4" type="radio" name="rating" value="4"  /><label for="rating-4"><i class="fa fa-star" style="font-size: 20px"></i></label>
                            <input id="rating-3" type="radio" name="rating" value="3"/><label for="rating-3"><i class="fa fa-star" style="font-size: 20px"></i></label>
                            <input id="rating-2" type="radio" name="rating" value="2"/><label for="rating-2"><i class="fa fa-star" style="font-size: 20px"></i></label>
                            <input id="rating-1" type="radio" name="rating" value="1"/><label for="rating-1"><i class="fa fa-star" style="font-size: 20px"></i></label>
                        </div>
                        <p class="product-rating-error text-danger"></p>
                      </div>
                        <div class="form-group mb-3 pt-1 pl-3">
