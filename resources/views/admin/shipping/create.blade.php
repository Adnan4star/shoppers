                    ...
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="form-responsive" style="margin-top: 20px; margin-left: 20px; margin-right: 20px;">
                                <form class="form-horizontal form-vcenter" action="" method="POST" id="shippingForm" name="shippingForm" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 row">
                                        <label for="amount" class="col-3 col-form-label"></label>
                                        <div class="col">
