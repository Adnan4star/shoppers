@extends('admin.layouts.app') {{--This is child layout and i am calling parent layout(app.blade.php)--}}
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="form-responsive" style="margin-top: 20px; margin-left: 20px; margin-right: 20px;">
                                <form class="form-horizontal form-vcenter" action="" method="POST" id="roleForm" name="roleForm" enctype="multipart/form-data">
                                    <div class="mb-3 row">
    ...
    <script> //validating form through ajax
        $("#roleForm").submit(function(event){
            ...
            var registerData = $("#roleForm")[0];
            var element = new FormData(registerData)

            $.ajax({
                url: "{{ route('users.roleStore') }}",
                type: 'post',
                data: element,
                contentType: false,
                processData: false,
